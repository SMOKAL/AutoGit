 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "6c69729c-8465-42b3-a2b6-326ca404bf8c",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Most recent commit SHA: 18bbd36ce5c5cd7c72d16b721a08e0c907e9791b\n",
      "Files changed in the most recent commit:\n",
      "{'Rules/Rule3AddressVerification.sql'}\n",
      "Rule3AddressVerification\n",
      "\n",
      "\n",
      ...
      "\n",
      "Matching filenames:\n",
      "NewFolder/BusinessData/Dir2.sql\n",
      "Report/Report1.sql\n",
   ...
   "source": [
    ...
    "headers = {\n",
    "    'Authorization': 'token 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',\n",
    ...
    "def overwrite_content_in_files(repo_owner, repo_name, matching_files, start_pattern, end_pattern, new_content, auth_token):\n",
    "    headers = {'Accept': 'application/vnd.github.v3+json','Authorization': f'token {auth_token}'}\n",
    ...
    "new_content = content\n",
    "auth_token = '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'  # Replace with your GitHub personal access token\n",
    "\n",
    "\n",
    "try:\n",
    ...
    "        print(filename)\n",
    "    overwrite_content_in_files(repo_owner, repo_name, matching_files, start_pattern, end_pattern, new_content, auth_token)\n",
  ...
  },
  {
   ...
   "id": "8e548322-bd0b-4d07-94b0-14f6603a1a5f",
   "metadata": {},
   "outputs": [],
   "source": []
  }
